...
namespace NzbDrone.Core.Movies
{
    ...
    public class MovieRepository : BasicRepository<Movie>, IMovieRepository
    {
        ...
        private Movie Map(Dictionary<int, Movie> dict, Movie movie, Profile profile, MovieFile movieFile)
        {
            Movie movieEntry;
        ...
        private List<Movie> FindByAltTitles(List<string> titles)
        {
            ...
            _ = _database.QueryJoined<Profile, Movie, MovieFile>(
                builder,
                (profile, movie, file) =>
                {
                    _ = Map(movieDictionary, movie, profile, file);
                    return null;
                });
